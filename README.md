...
```bash
./scripts/generate_known_versions.py 0.0.39
```
...
version = "0.0.39"
known_versions = [
  "0.0.39|linux_arm64|<sha256>|<size>",
  "0.0.39|linux_x86_64|<sha256>|<size>",
  "0.0.39|macos_arm64|<sha256>|<size>",
  "0.0.39|macos_x86_64|<sha256>|<size>",
]
```
...
```bash
./scripts/generate_known_versions.py 0.0.39 --platform macos_arm64 --platform linux_x86_64
./scripts/generate_known_versions.py 0.0.39 --entries-only
```
...
- create an annotated tag like `v0.1.8`
- push `main`
- push the tag
...
```bash
mise run release-dry-run 0.1.8
mise run release -- --skip-checks 0.1.8
```
